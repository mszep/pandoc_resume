...
\startdescription{Programming Languages}
  Shell Unix, C/C++/C\#, Java, Python, SQL, Matlab, HTML5/CSS3, OpenCV,
  OpenGL, Qt, PHP, JavaScript, MS-DOS, VHDL
...
\startdescription{DevOps and tools}
  ...
  \useURL[url16][http://nodejs.org][][link]\from[url16]) which was
...
\startdescription{Languages}
  ...
  \useURL[url17][https://github.com/githubuser/superlongprojectname][][link]\from[url17],
...
\startblockquote
\useURL[url18][mailto:email@example.com][][email@example.com]\from[url18]
